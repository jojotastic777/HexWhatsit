...
abstract class HexwhatsitModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexwhatsitModDependenciesExtension>("hexwhatsitModDependencies")
